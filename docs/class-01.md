...
*Double quote string syntax*-র অনেক সুবিধা আছে। যেমন:- ***Escaped Sequences***-র ব্যবহার। পাশাপাশি `("")`-র ভেতর টেক্সট ভ্যালুগুলোর সাথে কোন *variable*-র নাম লিখলে তা এক্সিকিউট হয়ে *variable*-র ভ্যালুটা পাওয়া যায়।
