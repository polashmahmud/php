...
>
> *modulo operation* এর রেজাল্ট তথা ভাগশেষ সবসময় ভাজ্যের *(dividend)* সাইন গ্রহণ করবে; অর্থাৎ `$a % $b` এর ভেতরকার অপারেশনের ফলাফল-মান সবসময় `$a` ভ্যারিয়েবলের মান ধারণ করবে। সুতরাং `$a` ভাজ্য পজিটিভ সংখ্যা হলে ভাগশেষ তথা ফলাফল পজিটিভ হবে, নেগেটিভ হলে নেগেটিভ। যেমন:-
>
> ```php
><?php
>
