...
এবার আসুন আমরা এমন একটা ফাংশন সম্পর্কে জানি যে আপনাকে বলে দেবে আপনার ইনপুট দেয়া ডাটা কি একটা সংখ্যা নাকি না। সেই ফাংশনটি হল, [`is_nan()`](https://www.php.net/manual/en/function.is-nan.php)। যাকে আপনি একটা ফ্লোট নাম্বার প্যারামিটার হিসেবে দেবেন এবং সে চেক করবে নাম্বারটি কি আসলেই কোন নাম্বার নাকি অন্য কোন টাইপের ডাটা। যদি ইনপুট দেয়া নাম্বারটি আসলে কোন নাম্বার না হয় তাহলে ফাংশনটি থেকে আপনি *true* রিটার্ন পাবেন। অন্যথায় *false* রিটার্ন পাবেন।
...
এখন ঐ ফাংশন তার ক্যালকুলেশন শেষে কি রিটার্ন দেবে? সে রিটার্ন দেবে `NAN`। সে তার সাধ্যমত চেষ্টা করেও আপনার দেয়া ভুল ইনফরমেশনের কারণে নিজ দায়িত্ব সম্পূর্ণ করতে পারেনি। ফলে সে ঐ ডাটাকে নাম্বার বিবর্জিত ডাটা মনে করে তার টাইপ সেট করে দেবে `NAN`।
