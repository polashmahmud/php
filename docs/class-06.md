...
3. এই আর্গুমেন্টটিও ঐচ্ছিক। এটি ২য় আর্গুমেন্টের সাথে মিলে কাজ করে। এখানে আমরা 1টি বুলিয়ান ভ্যালু পাস করতে পারি। `true` বা
   `false`। ডিফল্ট ভ্যালু `false` থাকে। এই আর্গুমেন্ট এর কাজ হল, অ্যারের ভ্যালু অনুযায়ী key সার্চ করার যে প্রসেস ফাংশনটি রান করে সেখানে **strict comparison (===)** করা হবে কিনা তা টিক করা। `true` পাস করার অর্থ, সার্চ করার প্রসেসে strict comparison করা হবে।
