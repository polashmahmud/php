...
3. এই আর্গুমেন্টটিও ঐচ্ছিক। এটি ২য় আর্গুমেন্টের সাথে মিলে কাজ করে। এখানে আমরা 1টি বুলিয়ান ভ্যালু ( `true` বা
   `false`) পাস করতে পারি। এই আর্গুমেন্ট এর কাজ হল, অ্যারের ভ্যালু অনুযায়ী key সার্চ করার যে প্রসেস ফাংশনটি রান হয় সেখানে **strict comparison (===)** করা হবে কিনা তা নির্দিষ্ট করা। `true` পাস করার অর্থ, সার্চ করার প্রসেসে strict comparison করা হবে। এই আর্গুমেন্ট এর ডিফল্ট ভ্যালু `false` থাকে।
...
ম্যাপ ফাংশন দিয়ে চমৎকার যে কাজটি করা যায় তা হল, একাধিক অ্যারে আর্গুমেন্ট আকারে পাস করে array of arrays বা বলতে পারি মাল্টিডাইমেনশনাল অ্যারে তৈরি করা যায়। এজন্য কলব্যাক ফাংশনের জায়গায় আমাদেরকে **null** পাস করতে হবে। একে zip operation বলা হয়। উদাহরণ দেখিঃ
