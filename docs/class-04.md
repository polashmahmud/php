...
অতঃপর *Parentheses* `()` লিখতে হয়। *Parentheses* `()` বা ১ম বন্ধনী মূলত প্যারামিটার লিখতে ব্যবহৃত হয়। প্যারামিটার কি জিনিস আমরা একটু পরই জানতে পারব। যদি ফাংশনের কোন প্যারামিটার না থাকে, তবুও জেনারেল ফাংশন তৈরিতে এই *Parentheses* `()` লিখতে হয়।
